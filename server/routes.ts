  ...
  app.post('/api/generate/files', async (req, res) => {
    ...
    try {
      ...
      const generationRequest = {
        prompt: `Generate an advanced, enterprise-grade application for PEAKS platform: ${prompt}

        ADVANCED REQUIREMENTS:
        - Create complete, production-ready application with full functionality
        - Use cutting-edge technologies and design patterns
        - Implement stunning UI with smooth animations and micro-interactions
        - Add comprehensive features: search, filtering, real-time updates
        - Include proper accessibility, SEO, and performance optimizations
        - Generate realistic, high-quality content (no placeholders)
        - Create modular, scalable architecture
        - Add advanced JavaScript functionality and state management`,
