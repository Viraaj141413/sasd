    ...
    <div className="h-screen bg-[#0d1117] text-white flex flex-col">
      ...
      <div className="bg-[#161b22] border-b border-gray-700 p-3 flex justify-between items-center">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="font-semibold text-lg">PEAKS</span>
          </div>
        </div>
      ...
      <div className="flex-1 flex overflow-hidden">
          ...
          <div className="p-4 border-t border-gray-700 bg-[#0d1117]">
            <div className="flex space-x-3">
              <Input
                ...
                className="flex-1 bg-[#161b22] border-gray-600 text-white text-sm h-12 px-4 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors"
        ...
        <div className="w-2/5 flex min-w-0">
          {/* Files Panel - Better Proportioned */}
          <div className="w-48 bg-[#161b22] border-r border-gray-700 flex flex-col shrink-0">
            ...
            <div className="flex-1 overflow-y-auto p-2 min-h-0">
              {Object.keys(files).length === 0 ? (
                <div className="text-center text-gray-400 text-xs mt-8 px-2">
                  <FileText className="w-8 h-8 mx-auto mb-2 opacity-50" />
                  <p>No files yet</p>
                  <p className="mt-1 text-gray-500">Start by describing what you want to build</p>
                </div>
              ) : (
                Object.entries(files).map(([filename, file]) => (
                  <div
                    ...
                    className={`flex items-center px-3 py-2 cursor-pointer hover:bg-gray-700 rounded-md text-sm transition-colors mb-1 ${
                      activeFile === filename ? 'bg-gray-700 text-blue-400 border border-blue-500/20' : 'text-gray-300'
                    }`}
                    title={filename}
                  >
